...
GB_shapes %>%  ggplot(aes(shape, fill = ..count..)) + geom_bar() + scale_fill_gradient(low = "green", high = "blue") + theme_minimal()  + theme(axis.text.x = element_text(angle = 45, hjust = 1),legend.position = "none") + labs(x="Oblici",y="Broj Događajna",title="Raspored top 10 oblika u VelikojBritaniji")
