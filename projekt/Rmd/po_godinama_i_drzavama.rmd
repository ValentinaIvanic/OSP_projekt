...
ggplot(country_year_counts,aes(year,total_sightings,color=country)) + geom_line(size = 1) + scale_y_sqrt() + labs(x="Godina",y="Ukupan broj viđenja",color="Država",title = "Broj viđenja u godini po državama")
